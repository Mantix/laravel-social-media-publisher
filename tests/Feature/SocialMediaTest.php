...
class SocialMediaTest extends TestCase
{
    ...
    public function testServiceProviderRegistration()
    {
        ...
        $this->assertTrue(app()->bound('mantix\LaravelSocialMediaPublisher\Services\YouTubeService'));
        $this->assertTrue(app()->bound('mantix\LaravelSocialMediaPublisher\Services\PinterestService'));
        $this->assertTrue(app()->bound('mantix\LaravelSocialMediaPublisher\Services\TelegramService'));
